...
namespace FundamentosCSharp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(textoFromNumero);
            //Console.ReadKey();
            ...
            //float outroNumero = 34.0f;
            //double outroDecimal = 3456.09;
            //Console.WriteLine("O número digitado foi! " + numDecimal);
            //if (numDecimal > 5)
            //{
            ...
            //while (numDecimal > 0)
            //{
            //    Console.WriteLine("Entre com um número decimal:(0 - para encerrar");
